package com.sournary.androidarchitecturecomponenttutorial.ext
...
/**
 * Created in 9/6/19 by Sang
 * Description: Manages the various graphs needed for a [BottomNavigationView].
 * Note: This sample is a workaround until the Navigation Component supports multiple back stacks.
 */
